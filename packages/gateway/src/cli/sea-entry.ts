...
// Installation must not materialize models or initialize the ordinary CLI.
async function main(): Promise<void> {
  if (process.argv[2] === "setup" && process.argv[3] === "--install") {
    const { commandInstall } = await import("./install");
