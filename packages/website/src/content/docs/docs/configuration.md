...
This page is auto-generated from the Zod schema in `packages/core/src/config.ts`. If you change the schema, run `pnpm run generate:docs` to regenerate this file.
